...
public class Principal10 {
    ...
    public static void main(
        ...
        ContaInvestimento conta2 = new ContaInvestimento(new Titular("João da Silva", "12312322300"), 1234, 999999);
        conta2.depositar(100);
        conta2.creditarRendimentos(10);

        ContaSalario conta3 = new ContaSalario(new Titular("João da Silva", "12312322300"), 1234, 999999, 18_000);
